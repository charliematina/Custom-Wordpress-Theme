<?php
	/*
		Template Name: Architecture Projects Page Template
	*/
 ?>
<?php get_header(); ?>
	...
	<div class="main-content contact-page-wrapper">
		<div class="page-detail-wrapper">
			...
			<div class="flex-row projects-container project-page">
				<?php $args = array( 'post_type' => 'project', 'posts_per_page' => 99, 'tax_query' => array(
					array(
						'taxonomy' => 'tag',
						'field'    => 'slug',
						'terms'    => array('architecture','architect','architect design'),
					),
				),)?>
